...
from .serializers import UserSerializer, RestaurantSerializer, ProfileSerializer, MacroTrackerSerializer, FavoriteMealSerializer
...
class FavoriteMealViewSet(viewsets.ModelViewSet):
    ...
    def log(self, request, pk=None):
        ...
        tracker, _ = MacroTracker.objects.get_or_create(user=request.user, date=date.today())
        tracker.items.add(*items_to_log)
